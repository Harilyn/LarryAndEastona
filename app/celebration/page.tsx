        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div className="flex flex-col items-center rounded-lg bg-white p-8 text-center shadow-md">
              ...
              <Button variant="outline" className="mt-4 border-sage-600 text-sage-600 hover:bg-sage-50" asChild>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="mx-auto max-w-2xl text-center">
            <p className="mb-8 text-sage-700">
              ...
              have created an Amazon registry with items for our new home together. Alternatively, you can contribute to
              our home fund through mobile money.
            </p>
            <div className="grid gap-6 md:grid-cols-2">
              <div className="flex flex-col items-center rounded-lg bg-white p-6 shadow-md">
                ...
                <h3 className="mb-2 font-serif text-xl text-sage-800">Amazon Registry</h3>
                <p className="mb-4 text-sage-700">
                  We've created a registry with items we would love for our new home.
                </p>
                <Button className="mt-2 bg-sage-600 hover:bg-sage-700" asChild>
                  <Link
                    href="https://www.amazon.com/wedding/registry/1X6XM66ZYM0VB"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    View Registry
              ...
              <div className="flex flex-col items-center rounded-lg bg-white p-6 shadow-md">
                <Gift className="mb-4 h-10 w-10 text-sage-600" />
                <h3 className="mb-2 font-serif text-xl text-sage-800">Home Fund</h3>
                <p className="mb-4 text-sage-700">
                  To contribute to our home fund, please use the mobile money number below:
                </p>
                <div className="mb-4 rounded-md bg-sage-50 p-4 text-center">
                  <p className="font-medium text-sage-800">Orange Money: +232 79 123456</p>
                </div>
                <Button
                  className="mt-2 bg-sage-600 hover:bg-sage-700"
                  onClick={() => {
                    navigator.clipboard.writeText("+232 79 123456")
